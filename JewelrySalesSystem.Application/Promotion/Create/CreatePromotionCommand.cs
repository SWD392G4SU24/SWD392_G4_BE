...
namespace JewelrySalesSystem.Application.Promotion.CreatePromotion
{
    ...
    {
        public CreatePromtionCommand(string? description, decimal conditionsOfUse, float reducedPercent, decimal maximumReduce, int exchangePoint, DateTime expiresTime)
        {
