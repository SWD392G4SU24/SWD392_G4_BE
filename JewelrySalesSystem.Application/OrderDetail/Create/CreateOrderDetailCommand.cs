...
namespace JewelrySalesSystem.Application.OrderDetail.Create
{
    ...
    {
        public CreateOrderDetailCommand(string orderID, string productID, int quantity, decimal productCost, decimal? goldSellCost, decimal? goldBuyCost, decimal? diamondSellCost)
        {
            OrderID = orderID;
            ProductID = productID;
            Quantity = quantity;
