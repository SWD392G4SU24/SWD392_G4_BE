...
namespace JewelrySalesSystem.Application.Order
{
    public static class OrderMappingExtenstion
    {
        ...
        public static OrderDto MapToOrderDto(this OrderEntity projectFrom, IMapper mapper, string? counter, string fullName, string paymentMethod)
        {
        ...
        public static List<OrderDto> MapToOrderDtoList(this IEnumerable<OrderEntity> projectFrom, IMapper mapper, Dictionary<int, string> counter, Dictionary<string, string> fullName, Dictionary<int, string> paymentMethod)
